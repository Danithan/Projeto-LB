...
Todo o processo de desenvolvimento — do levantamento de requisitos até as decisões técnicas — está documentado na pasta docs/:

01-requisitos.md — documento de requisitos funcionais e não funcionais
...
Equipe
Daniel Nathan — [Github Daniel](https://github.com/Danithan)
